...
| 2 | 上下文工程 | [内容精读](内容精读/第2章%20上下文工程.md) | [实验解读](实验解读/第2章%20上下文工程.md) | [思考题引导](思考题引导/第2章%20上下文工程.md) | [回应与补充](DeepReadNote/第2章%20回应与补充.md) | ✅ 已精读 |
| 3 | 用户记忆和知识库 | [内容精读](内容精读/第3章%20用户记忆和知识库.md) | [实验解读](实验解读/第3章%20用户记忆和知识库.md) | [思考题引导](思考题引导/第3章%20用户记忆和知识库.md) | [回应与补充](DeepReadNote/第3章%20回应与补充.md) | ✅ 已精读 |
| 4 | 工具 | [内容精读](内容精读/第4章%20工具.md) | [实验解读](实验解读/第4章%20工具.md) | [思考题引导](思考题引导/第4章%20工具.md) | [回应与补充](DeepReadNote/第4章%20回应与补充.md) | ✅ 已精读 |
| 5 | Coding Agent 与通用 Agent | [内容精读](内容精读/第5章%20Coding%20Agent%20与通用%20Agent.md) | [实验解读](实验解读/第5章%20Coding%20Agent%20与通用%20Agent.md) | [思考题引导](思考题引导/第5章%20Coding%20Agent%20与通用%20Agent.md) | — | ✅ 已精读 |
...
| 2026-09-13 | 第 2 章 DeepReadNote（回应 QuickNote_2：Transformer/KV Cache 补充、位置偏好、KV Cache vs Prompt Cache 对比、状态栏代价公式推导）；新增《如何编写一份可用的 Skill》指南（对照 frontend-design 实例） |
| 2026-09-13 | 第 3 章「用户记忆和知识库」精读完成（内容精读 14 张图 + 实验解读 12 个实验 + 思考题引导 9 题） |
| 2026-09-14 | 第 3 章 DeepReadNote（自定义记忆场景 + mnemon 三层结构解析）；新增专题《wiki 知识库搭建》（raw→总结→建模→检索 全流程方案） |
| 2026-09-14 | 第 4 章「工具」精读完成（内容精读 + 实验解读 5 个实验 + 思考题引导 4 题，含 4 张图） |
| 2026-09-15 | 第 4 章 DeepReadNote（异步回调、工具描述精度、MCP vs Skill 注册表） |
| 2026-09-15 | 第 5 章「Coding Agent 与通用 Agent」精读完成（内容精读 + 实验解读 16 个实验 + 思考题引导 9 题，含 11 张图） |
| — | 第 6–10 章：待精读（骨架已就位） |
