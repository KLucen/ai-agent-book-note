...
| 2026-09-15 | 第 3 章 DeepReadNote（自定义记忆场景 + mnemon 三层结构解析）；新增专题《wiki 知识库搭建》（raw→总结→建模→检索 全流程方案） |
| 2026-09-15 | 第 4 章「工具」精读完成（内容精读 + 实验解读 5 个实验 + 思考题引导 4 题，含 4 张图） |
| 2026-09-21 | 第 4 章 DeepReadNote（异步回调、工具描述精度、MCP vs Skill 注册表） |
| 2026-09-21 | 第 5 章「Coding Agent 与通用 Agent」精读完成（内容精读 + 实验解读 16 个实验 + 思考题引导 9 题，含 11 张图） |
| — | 第 6–10 章：待精读（骨架已就位） |
